...
public class DefaultRemitToAddress {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DefaultRemitToAddress other = (DefaultRemitToAddress) obj;
		if (address1 == null) {
	...
	public String toString() {
		return "DefaultRemitToAddress [facilityName=" + facilityName
				+ ", address1=" + address1 + ", address2=" + address2
				+ ", country=" + country + ", postalCode=" + postalCode
				+ ", phone1=" + phone1 + ", fax1=" + fax1 + ", state=" + state
				+ ", city=" + city + ", email1=" + email1 + ", phone2="
				+ phone2 + "]";
	}
