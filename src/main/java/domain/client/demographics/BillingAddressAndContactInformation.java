...
public class BillingAddressAndContactInformation {
	private String contact1="";
	private String prefContactMthd="";
	...
	public String getPrefContactMthd() {
		return prefContactMthd;
	}

	public void setPrefContactMthd(String prefContactMthd) {
		this.prefContactMthd = prefContactMthd;
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((prefContactMthd == null) ? 0 : prefContactMthd.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BillingAddressAndContactInformation other = (BillingAddressAndContactInformation) obj;
		if (address1 == null) {
		...
		if (postalCode == null) {
			...
			return false;
		if (prefContactMthd == null) {
			if (other.prefContactMthd != null)
				return false;
		} else if (!prefContactMthd.equals(other.prefContactMthd))
			return false;
		if (state == null) {
			if (other.state != null)
				return false;
	...
	public String toString() {
		return "BillingAddressAndContactInformation ["
				+ "contact1=" + contact1 
				+ ", prefContactMthd=" + prefContactMthd
				+ ", address1=" + address1 
				+ ", address2=" + address2 
				+ ", country=" + country 
