...
public class PayorAddressAndContactInformation {

	private String contact1 = "";
	private String PrefContMethod = "";
	...
	public String getPrefContMethod() {
		return PrefContMethod;
	}

	public void setPrefContMethod(String prefContMethod) {
		PrefContMethod = prefContMethod;
	}
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((PrefContMethod == null) ? 0 : PrefContMethod.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PayorAddressAndContactInformation other = (PayorAddressAndContactInformation) obj;
		if (PrefContMethod == null) {
			if (other.PrefContMethod != null)
				return false;
		} else if (!PrefContMethod.equals(other.PrefContMethod))
			return false;
		if (address1 == null) {
	...
	public String toString() {
		return "PayorAddressAndContactInformation [" + "contact1=" + contact1 + ", PrefContMethod=" + PrefContMethod
				+ ", address1=" + address1 + ", address2=" + address2 + ", country=" + country + ", postalCode="
				+ postalCode + ", city=" + city + ", state=" + state + ", phone1=" + phone1 + ", fax1=" + fax1
				+ ", email1=" + email1 + ", contact2=" + contact2 + ", phone2=" + phone2 + ", fax2=" + fax2
				+ ", email2=" + email2 + "]";
	}
