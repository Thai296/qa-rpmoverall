...
public class ReasonCodeConfigSearchResults {
	private RemoteWebDriver driver;	
	protected Logger logger;

	public ReasonCodeConfigSearchResults(RemoteWebDriver driver){
		this.driver = driver;
	...
	public WebElement reasonCodeIdColLnk(String row) throws Exception{ 
