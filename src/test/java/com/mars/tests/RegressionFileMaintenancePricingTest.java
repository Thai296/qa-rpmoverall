...
public class RegressionFileMaintenancePricingTest extends SeleniumBaseTest  {
	...
	*/
	...
	public void testRPM_28(String email, String password, String project, String testSuite, String testCase, String propLevel, String propName, String wsUsername, String wsPassword) throws Exception {
    	...
    	String accnId = testDataSetup.sendWSReqestTestCase(project, testSuite, testCase, propLevel, propName, orgAlias, wsUsername, wsPassword, testDb);
